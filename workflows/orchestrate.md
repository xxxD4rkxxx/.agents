...
| **API** | backend-specialist, auditor-seguranca, test-engineer |
| **UI/Design** | frontend-specialist, seo-specialist, otimizador-desempenho |
| **Database** | database-architect, backend-specialist, auditor-seguranca |
| **Full Stack** | planejador-projeto, frontend-specialist, backend-specialist, devops-engineer |
| **Debug** | depurador, explorador, test-engineer |
| **Security** | auditor-seguranca, penetration-tester, devops-engineer |
...
| Step | Agent | Action |
|------|-------|--------|
| 1 | `planejador-projeto` | Create docs/PLAN.md |
| 2 | (optional) `explorador` | Codebase discovery if needed |

> ðŸ”´ **NO OTHER AGENTS during planning!** Only planejador-projeto and explorador.
...
|----------------|--------|
| Foundation | `database-architect`, `auditor-seguranca` |
...
|-------|--------|----------|
| `planejador-projeto` | Planning | Task breakdown, PLAN.md |
| `explorador` | Discovery | Codebase mapping |
| `frontend-specialist` | UI/UX | React, Vue, CSS, HTML |
| `backend-specialist` | Server | API, Node.js, Python |
| `database-architect` | Data | SQL, NoSQL, Schema |
| `auditor-seguranca` | Security | Vulnerabilities, Auth |
| `penetration-tester` | Security | Active testing |
| `test-engineer` | Testing | Unit, E2E, Coverage |
| `devops-engineer` | Ops | CI/CD, Docker, Deploy |
| `desenvolvedor-mobile` | Mobile | React Native, Flutter |
| `otimizador-desempenho` | Speed | Lighthouse, Profiling |
| `seo-specialist` | SEO | Meta, Schema, Rankings |
| `documentation-writer` | Docs | README, API docs |
| `depurador` | Debug | Error analysis |
| `game-developer` | Games | Unity, Godot |
| `orquestrador` | Meta | Coordination |
...
```
â–¡ Security     â†’ auditor-seguranca, penetration-tester
...
â–¡ Mobile       â†’ desenvolvedor-mobile
â–¡ Performance  â†’ otimizador-desempenho
â–¡ SEO          â†’ seo-specialist
â–¡ Planning     â†’ planejador-projeto
```
...
**PHASE 1 (Planning):**
```
Use the planejador-projeto agent to create PLAN.md
...
- Previous Work: orquestrador asked 6 questions, user chose all options
...
|---|-------|------------|--------|
| 1 | planejador-projeto | Task breakdown | âœ… |
