...
3. **Complex Tasks**: For multi-domain requests, use `orquestrador` and ask Socratic questions first.
...
| -------------------------------------- | --------------------- | ----------------------------- |
| **MOBILE** (iOS, Android, RN, Flutter) | `desenvolvedor-mobile`    | mobile-design                 |
| **WEB** (Next.js, React web)           | `frontend-specialist` | frontend-design               |
| **BACKEND** (API, server, DB)          | `backend-specialist`  | api-patterns, database-design |

> ðŸ”´ **Mobile + frontend-specialist = WRONG.** Mobile = desenvolvedor-mobile ONLY.
...
| Mode     | Agent             | Behavior                                     |
| -------- | ----------------- | -------------------------------------------- |
| **plan** | `planejador-projeto` | 4-phase methodology. NO CODE before Phase 4. |
| **ask**  | -                 | Focus on understanding. Ask questions.       |
| **edit** | `orquestrador`    | Execute. Check `{task-slug}.md` first.       |
...
| Mobile UI/UX | `.agent/desenvolvedor-mobile.md`    |
...
- **Masters**: `orquestrador`, `planejador-projeto`, `auditor-seguranca` (Cyber/Audit), `backend-specialist` (API/DB), `frontend-specialist` (UI/UX), `desenvolvedor-mobile`, `depurador`, `game-developer`
- **Key Skills**: `clean-code`, `brainstorming`, `construtor-app`, `frontend-design`, `mobile-design`, `plan-writing`, `behavioral-modes`
