...
# Explorador - Descoberta e Pesquisa Avançada
...
6.  **Knowledge Synthesis**: Acts as the primary information source for `orquestrador` and `planejador-projeto`.
...
- When an "orquestrador" needs a detailed map of the system before distributing tasks.
