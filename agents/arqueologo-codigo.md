...
|-------|---------------------|---------------------|
| `engenheiro-testes` | Golden master tests | Testability assessments |
| `auditor-seguranca` | Vulnerability checks | Legacy auth patterns |
| `planejador-projeto` | Migration timelines | Complexity estimates |
