...
|-------|---------------------|---------------------|
| `engenheiro-testes` | Unit test gaps | E2E coverage reports |
| `engenheiro-devops` | Pipeline resources | Pipeline scripts |
| `especialista-backend` | Test data APIs | Bug reproduction steps |
