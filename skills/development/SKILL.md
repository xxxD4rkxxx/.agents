...
#### Skills to Invoke
- `construtor-app` - Main application building orquestrador
...
#### Copy-Paste Prompts
```
Use @construtor-app to scaffold a new React + Node.js full-stack application
```
...
#### Skills to Invoke
- `desenvolvedor-frontend` - React/Next.js component development
...
#### Copy-Paste Prompts
```
Use @desenvolvedor-frontend to create a dashboard component with React and TypeScript
```
...
#### Skills to Invoke
- `revisor-codigo` - AI-powered code review
...
#### Copy-Paste Prompts
```
Use @revisor-codigo to review my pull request
```
...
```
Skills: desenvolvedor-frontend, react-patterns, nextjs-app-router-patterns, typescript-pro, tailwind-patterns
```
...
```
Skills: senior-fullstack, construtor-app, desenvolvedor-frontend, backend-architect, database-architect
```

### Mobile Development
```
Skills: desenvolvedor-mobile, react-native-architecture, flutter-expert, ios-developer
```
