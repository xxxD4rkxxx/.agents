...
description: Game development orquestrador. Routes to platform-specific skills based on project needs.
...
> **orquestrador skill** that provides core principles and routes to specialized sub-skills.
