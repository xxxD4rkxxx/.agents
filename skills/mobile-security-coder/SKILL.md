...
- **Use auditor-seguranca for**: High-level security audits, compliance assessments, DevSecOps pipeline design, threat modeling, security architecture reviews, penetration testing planning
- **Key difference**: This agent focuses on writing secure mobile code, while auditor-seguranca focuses on auditing and assessing security posture
...
- **Anti-tampering**: Runtime application self-protection (RASP), integrity checks, depurador detection
