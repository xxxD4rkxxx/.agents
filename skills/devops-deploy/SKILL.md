---
name: devops-implantar
description: 'DevOps e deploy de aplicacoes â€” Docker, CI/CD com GitHub Actions, AWS Lambda, SAM, Terraform, infraestrutura como codigo e monitoramento. Ativar para: dockerizar aplicacao, configurar pipeline...'
risk: critical
source: community
...
# devops-implantar â€” Da Ideia para Producao
