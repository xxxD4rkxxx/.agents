...
Loki Mode has **37 predefined agent types** organized into **6 specialized swarms**. The orquestrador spawns only what you needâ€”simple projects use 5-10 agents, complex startups spawn 100+.
...
IMPLEMENT â†’ REVIEW (parallel) â†’ AGGREGATE â†’ FIX â†’ RE-REVIEW â†’ COMPLETE
                â”‚
                â”œâ”€ revisor-codigo (Opus) - Code quality, patterns, best practices
...
```
.loki/
â”œâ”€â”€ state/          # orquestrador and agent states
