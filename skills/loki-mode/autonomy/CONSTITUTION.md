...
- MUST update orquestrador.json after phase transitions
...
- MUST track infrastructure state in orquestrador.json
...
```json
{
  ...
  "spawned_by": "orquestrador-main",
  "lineage": ["orquestrador-main", "eng-001-backend-api"],
  "inherited_context": {
    "phase": "development",
