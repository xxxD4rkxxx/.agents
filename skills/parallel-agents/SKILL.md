...
### Single Agent
```
Use the auditor-seguranca agent to review authentication
```

### Sequential Chain
```
First, use the explorador to discover project structure.
...
```
Agents: explorador â†’ [domain-agents] â†’ synthesis

1. explorador: Map codebase structure
2. auditor-seguranca: Security posture
...
```
Agents: auditor-seguranca â†’ penetration-tester â†’ synthesis

1. auditor-seguranca: Configuration and code review
...
|-------|-----------|-----------------|
| `orquestrador` | Coordination | "comprehensive", "multi-perspective" |
| `auditor-seguranca` | Security | "security", "auth", "vulnerabilities" |
...
| `desenvolvedor-mobile` | Mobile | "React Native", "Flutter", "mobile" |
| `api-designer` | API Design | "REST", "GraphQL", "OpenAPI" |
| `depurador` | Debugging | "bug", "error", "not working" |
| `explorador` | Discovery | "explore", "map", "structure" |
| `documentation-writer` | Documentation | "write docs", "create README", "generate API docs" |
| `otimizador-desempenho` | Performance | "slow", "optimize", "profiling" |
| `planejador-projeto` | Planning | "plan", "roadmap", "milestones" |
