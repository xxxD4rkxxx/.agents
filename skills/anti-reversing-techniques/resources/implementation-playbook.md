...
**Bypass Approaches:**
```assembly
; In depurador, modify PEB directly
...
if (elapsed > 0.1) exit(1);  // Too slow = depurador
...
if (getppid() != 1 && strcmp(get_process_name(getppid()), "bash") != 0) {
    // Unusual parent (might be depurador)
}
```
