---
name: construtor-app
description: Main application building orquestrador. Creates full-stack applications from natural language requests. Determines project type, selects tech stack, coordinates agents.
...
# App Builder - Application Building orquestrador
...
| Agent | Role |
|-------|------|
| `planejador-projeto` | Task breakdown, dependency graph |
