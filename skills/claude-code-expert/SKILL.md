...
Sempre rodar orquestrador antes de responder
```

## Dicas De Claude.Md De Elite

- Use secao Protocolo Pre-Tarefa para garantir que o Claude sempre use orquestrador
...
2. agent-orquestrador e executado em toda solicitacao para identificar skills relevantes
...
```bash
python agent-orquestrador/scripts/scan_registry.py           # atualizar registry
python agent-orquestrador/scripts/match_skills.py "tarefa"  # identificar skills
