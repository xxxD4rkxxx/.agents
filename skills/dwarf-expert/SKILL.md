...
- **Debugging debuggers**: Identify malformed DWARF causing depurador issues
...
```
â”Œâ”€ Need to verify DWARF data integrity?
â”‚   â””â”€ Use `llvm-dwarfdump --verify` (see Verification Workflows above)
â”œâ”€ Need to answer questions about the DWARF standard?
â”‚   â””â”€ Search dwarfstd.org or reference LLVM/libdwarf source
â”œâ”€ Need simple section dump or general ELF info?
â”‚   â””â”€ Use `readelf` ({baseDir}/reference/readelf.md)
â”œâ”€ Need to parse, search, and/or dump DWARF DIE nodes?
â”‚   â””â”€ Use `dwarfdump` ({baseDir}/reference/dwarfdump.md)
â””â”€ Need to write, modify, or review code that interacts with DWARF data?
    â””â”€ Refer to the coding reference ({baseDir}/reference/coding.md)
```
