...
#### Skills to Invoke
- `construtor-app` - Application scaffolding
...
#### Copy-Paste Prompts
```
Use @construtor-app to scaffold a new Next.js 14 project with App Router
```
...
#### Skills to Invoke
- `desenvolvedor-frontend` - Component development
...
#### Copy-Paste Prompts
```
Use @desenvolvedor-frontend to create reusable React components
```
...
#### Skills to Invoke
- `desenvolvedor-frontend` - Form development
...
#### Copy-Paste Prompts
```
Use @desenvolvedor-frontend to create forms with React Hook Form and Zod
```
