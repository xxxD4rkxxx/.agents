...
- **Complements**: cloud-architect (infrastructure), auditor-seguranca (security), performance-engineer (optimization)
...
- **vs auditor-seguranca**: Incorporates security patterns; defers comprehensive security audit to auditor-seguranca
