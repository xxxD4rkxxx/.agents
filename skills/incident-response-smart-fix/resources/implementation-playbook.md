...
**Second: depurador Root Cause Identification**
...
Use Task tool with subagent_type="error-debugging::depurador" and subagent_type="comprehensive-review::revisor-codigo" for systematic investigation:

**First: depurador Code Analysis**
...
**Second: revisor-codigo Deep Dive**

**Prompt:**
```
Review code logic and identify design issues:

Context from depurador:
- Code path: {CODE_PATH}
...
- Security â†’ subagent_type="security-scanning::auditor-seguranca"
...
**Third: revisor-codigo Final Approval**
...
Use Task tool with subagent_type="comprehensive-review::revisor-codigo" for prevention strategies:
...
**Sequence:**
1. **Phase 1-2**: error-detective + depurador identify slow database queries
...
2. **Phase 2**: depurador + revisor-codigo investigate
...
6. **Phase 5**: revisor-codigo documents API contract changes
...
2. **Phase 2**: depurador + auditor-seguranca investigate
   - Context: "User input not sanitized in SQL WHERE clause, allows authentication bypass"
3. **Phase 3**: Task(subagent_type="security-scanning::auditor-seguranca")
...
5. **Phase 4b**: auditor-seguranca performs penetration testing
6. **Phase 5**: revisor-codigo documents security improvements and creates postmortem
