...
- For legal language or website policies â†’ consult `consultor-juridico`
- For security/privacy sections â†’ consult `auditor-seguranca`
- For headcount/ops metrics â†’ consult `analista-negocios`
